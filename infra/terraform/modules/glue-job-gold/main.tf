resource "aws_s3_object" "glue_script" {
  ...
  key    = "glue-scripts/materialize_gold.py"
  source = "${path.module}/../../../../python/glue_job_gold/materialize_gold.py"
  etag   = filemd5("${path.module}/../../../../python/glue_job_gold/materialize_gold.py")
}
...
resource "aws_glue_job" "gold" {
  ...
  default_arguments = {
    ...
    "--output_path"     = "s3://${var.gold_bucket}/vendas_confirmadas/"
    "--athena_output"   = "s3://${var.gold_bucket}/athena-results/"
